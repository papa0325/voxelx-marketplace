            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-3 col-sm-6 col-xs-1">
                        <div className="widget">
                            <h5>Newsletter</h5>
                            <p style={{fontWeight: '400'}}>Signup for our newsletter to get the latest news in your inbox.</p>
                            ...
                            <small style={{fontWeight: '400'}}>Your email is safe with us. We don't spam.</small>
                        </div>
                    </div>
                </div>
            </div>

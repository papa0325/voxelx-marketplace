            ...
            <section className='container'>
                <div className='row mt-md-5 pt-md-4'>
                    ...
                    <div className="col-md-6">
                        <div className="item_info"><p>Auctions ends in: <span style={{fontWeight: 700, color: "black"}}>17d 18h 30m 12s</span></p>
                            ...
                            <div className="de_tab_content">
                                ...
                                <h6>Price</h6>
                                <div class="nft-item-price"><img src="/img/misc/ethereum.svg" alt="" width={30}/>
                                    <span style={{ fontColor: '#0d0c22', color: '#0d0c22', fontWeight: 'bold', paddingRight: '10px', paddingLeft: '10px', marginBottom: '10px' }}>0.059</span>($253.67)
                                </div>

                                {/* button for checkout */}
                                <div className="d-flex flex-row mt-5">
                                    <button className='btn-main lead mb-5 mr15' onClick={() => setOpenCheckout(true)}>Buy Now</button>
                                    <button className='btn-main btn2 lead mb-5' onClick={() => setOpenCheckoutbid(true)}>Place a Bid</button>
                                </div>
                            </div>
                        </div>
                    </div>
